...
namespace NubeBooks.Data
{
    ...
    public partial class LibrosDBEntities : DbContext
    {
        ...
        public virtual ObjectResult<SP_Get_Rep_De_Items_Por_Vencimiento_Result> SP_Get_Rep_De_Items_Por_Vencimiento(Nullable<int> idEmpresa, Nullable<System.DateTime> fechaInicio, Nullable<System.DateTime> fechaFin, Nullable<System.DateTime> rFechaFin)
        {
            var idEmpresaParameter = idEmpresa.HasValue ?
                new ObjectParameter("IdEmpresa", idEmpresa) :
                new ObjectParameter("IdEmpresa", typeof(int));
        ...
        public virtual ObjectResult<SP_Rep_IngresosEgresos_PorMes_EnEmpresa_Result> SP_Rep_IngresosEgresos_PorMes_EnEmpresa(Nullable<int> idEmpresa)
        {
            var idEmpresaParameter = idEmpresa.HasValue ?
                new ObjectParameter("IdEmpresa", idEmpresa) :
                new ObjectParameter("IdEmpresa", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<SP_Rep_IngresosEgresos_PorMes_EnEmpresa_Result>("SP_Rep_IngresosEgresos_PorMes_EnEmpresa", idEmpresaParameter);
        }
    }
}
